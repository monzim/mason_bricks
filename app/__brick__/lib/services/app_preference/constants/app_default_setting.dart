...
class AppDefaultSettings {
  ...
  static String? get fontFamily => GoogleFonts.{{fontName}}().fontFamily;
  static Color get colorSchemeSeed => _colorSchemeSeed;

  static const _isDarkMode = false;
  static const _isSystemThemeMode = {{systemDefaultTheme}};
  static const _locale = AppLocales.enUS;
  static const _colorSchemeSeed = Colors.{{materialThemeColor}};
}
